...
def VSHdeg01_fitting(dRA, dDE, e_dRA, e_dDE, RA, DE, flog=None, cov=None,
    ...
    if elim_flag is "None" or elim_flag is "none":
        x, sig, cofmat = VSH_deg01(dRA, dDE, e_dRA, e_dDE, RA, DE, cov,
                                   fit_type)
        # fit_type, max_num)
        ind_go = np.arange(dRA.size)

    elif elim_flag is "sigma":
        x, sig, cofmat = VSH_deg01(dRA, dDE, e_dRA, e_dDE, RA, DE,
                                   cov, fit_type)
        # Iteration.
        num1 = 1
        num2 = 0
